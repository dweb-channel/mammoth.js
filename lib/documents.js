...
function Paragraph(children, properties) {
    ...
    return {
        ...
        bgColor: properties.bgColor || null // Added background color attribute to paragraphs
    };
}
...
function Run(children, properties) {
    ...
    return {
        ...
        bgColor: properties.bgColor || null,  // added background color
        color: properties.color || null // added font color to text
    };
}
