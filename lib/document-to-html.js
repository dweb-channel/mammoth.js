...
function DocumentConversion(options, comments) {
    ...
    function convertRun(run, messages, options) {
        ...
        var paths = [];
         // Added a check whether there are additional tags
        var tagNumber = 0;
        // Generate attributes in advance and pass them in when generating tags
        ...
        // Finally, if there is no tag generated above and there is a style, generate a span tag and insert it.
